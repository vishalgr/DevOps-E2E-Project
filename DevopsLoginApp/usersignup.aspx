<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="usersignup.aspx.cs" Inherits="DevOpsLoginApp.usersignup" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 mx-auto">
                <div class="card text-white bg-info mb-3" style="max-width: 85rem;">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="TextBox4" runat="server" placeholder="DOB" TextMode="Date"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <a href="usersignup.aspx">
                                <asp:Button CssClass="btn btn-success btn-block btn-lg" ID="Button2" runat="server" type="button" Text="Sign Up" OnClick="Button2_Click"/></a>
                        </div>
                    </div>
                </div>
